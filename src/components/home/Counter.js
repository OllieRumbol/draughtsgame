...
export default function Counter(props) {
  ...
  if (props.state === 1) {
    return <div ref={ref} className={player1Css} onClick={click}></div>;
  } else if (props.state === 2) {
    return <div ref={ref} className={player2Css} onClick={click}></div>;
  } else if (props.state === 3) {
    return (
      <div ref={ref} className={player1Css} onClick={click}>
        K
      </div>
    );
  } else if (props.state === 4) {
    return (
      <div ref={ref} className={player2Css} onClick={click}>
        K
      </div>
    );
  } else {
