                ...
                <Col xl="10">
                    ...
                    <div>
                        ...
                        <div className="card-columns">
                            ...
                            <ProjectCard title="Draughts Game Phase 3 Epic" colour="danger" features={["Setting to decide who goes first", "Setting for if singles can take kings", "Update how to play", "Give up button", "Go back to player settings", "Display mode when against PC"]} status="Not started"></ProjectCard>
