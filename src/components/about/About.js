                ...
                <Col xl="10">
                    ...
                    <div>
                        ...
                        <div className="card-columns">
                            ...
                            <ProjectCard title="Mobile responsive UI Epic" colour="warning" features={["Game setup page is mobile responsive", "Game board page is mobile responsive", "How to play page is mobile responsive", "About page is mobile responsive"]} status="In progress"></ProjectCard>
                            ...
                            <ProjectCard title="Support Epic" colour="danger" features={["Game tips results in no possible moves (26/01/21)", "Player tips not showing all possible moves for a king (31/01/21)", "Player tips infinite loop (1/2/21)", "Double jumps and undo (2/2/21)", "Undo is hiding player tips when no moves have been made (6/2/21)", "Change board layout, currently back to front (16/2/21)", "No more moves check is too late"]} status="Paused due to no further work"></ProjectCard>
