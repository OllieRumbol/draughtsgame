                ...
                <Col xl="10">
                    ...
                    <div>
                        ...
                        <div className="card-columns">
                            ...
                            <ProjectCard title="Automated 2nd Player Phase 2 Epic" colour="warning" features={["Use some kind of genetic search algorithm to find best move", "Add new setting to the game setting page for other opponent type", "Use new setting in the frontend"]} status="In progress"></ProjectCard>
                            ...
                            <ProjectCard title="Draughts Game Phase 3 Epic" colour="danger" features={["Setting to decide who goes first", "Setting for if singles can take kings", "Update how to play"]} status="Not started"></ProjectCard>
                            <ProjectCard title="Automated 2nd Player Phase 3 Epic" colour="danger" features={["Refactor logic from V1 and V2", "Improve algorithm with alpha beta pruning", "Experiment with different depths", "Improve evaluation function"]} status="Not started"></ProjectCard>
                            <ProjectCard title="Tutorial 3 Epic" colour="danger" features={[]} status="Not started"></ProjectCard>
                            <ProjectCard title="Support Epic" colour="danger" features={["Game tips results in no possible moves (26/01/21)", "Player tips not showing all possible moves for a king (31/01/21)", "Player tips infinite loop (1/2/21)", "Double jumps and undo (2/2/21)", "Undo is hiding player tips when no moves have been made (6/2/21)", "Change board layout, currently  back to front", "No more moves check is too late"]} status="Paused due to no further work"></ProjectCard>
                            <ProjectCard title="Technical Debt Epic Epic" colour="danger" features={["Refactor main use effect logic (28/01/21)", "Refactor player tips logic"]} status="Paused due to no further work"></ProjectCard>
                        </div>
                    </div>
                    <br></br>
                </Col>
