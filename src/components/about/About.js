                ...
                <Col xl="10">
                    ...
                    <div>
                        ...
                        <div className="card-columns">
                            ...
                            <ProjectCard title="Technical Debt Epic Epic" colour="danger" features={["Refactor main use effect logic ✔ (28/1/21)", "Refactor player tips logic ✔ (28/2/21)", "Replace JS alert with bootstrap modal for invalid more ✔ (27/2/21)", "Refactor finding moves logic, going through the board twice ✔ (6/3/21)", "Skip comparison for non move pieces ✔ (8/3/21)"]} status="Paused due to no further work"></ProjectCard>
                        </div>
                    </div>
                    <br></br>
                </Col>
