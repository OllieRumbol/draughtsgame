                ...
                <Col xl="10">
                    ...
                    <div>
                        ...
                        <div className="card-columns">
                            ...
                            <ProjectCard title="Draughts Game Phase 3 Epic" colour="warning" features={["Setting to decide who goes first ✔", "Setting for if singles can take kings", "Update how to play", "Give up button ✔", "Go back to player settings", "Display mode when against PC ✔", "Better animation when an automated player takes multiple pieces"]} status="In progress"></ProjectCard>
                            <ProjectCard title="Automated 2nd Player Phase 3 Epic" colour="warning" features={["Refactor logic from V1, V2 and V3 ✔", "Improve algorithm with alpha beta pruning", "Experiment with different depths", "Improve evaluation function with pieces can be taken ✔", "Add new setting for new mode and use in frontend ✔", "Improve evaluation method for depth of pieces ✔", "Improve evaluation function to workout if the game has ended", "Move backend logic to API/ Serverless Function due to memory problems in the frontend ✔", "Create service to integrate frontend with backend ✔"]} status="In progress"></ProjectCard>
                            <ProjectCard title="Tutorial Epic" colour="danger" features={[]} status="Not started"></ProjectCard>
                            <ProjectCard title="Suggested Move Epic" colour="danger" features={[]} status="Not started"></ProjectCard>
                            ...
                            <ProjectCard title="Technical Debt Epic" colour="danger" features={["Refactor main use effect logic ✔ (28/1/21)", "Refactor player tips logic ✔ (28/2/21)", "Replace JS alert with bootstrap modal for invalid more ✔ (27/2/21)", "Refactor finding moves logic, going through the board twice ✔ (6/3/21)", "Skip comparison for non move pieces ✔ (8/3/21)", "Lots of shared logic between Board and PcBoard components"]} status="Paused due to no further work"></ProjectCard>
                        </div>
                    </div>
                    <br></br>
                </Col>
