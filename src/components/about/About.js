                ...
                <Col xl="10">
                    ...
                    <div>
                        ...
                        <div className="card-columns">
                            ...
                            <ProjectCard title="Support Epic" colour="danger" features={["Game tips results in no possible moves (26/01/21)", "Player tips not showing all possible moves for a king (31/01/21)"]} status="Paused due to no further work"></ProjectCard>
