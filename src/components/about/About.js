                ...
                <Col xl="10">
                    ...
                    <div>
                        ...
                        <div className="card-columns">
                            ...
                            <ProjectCard title="Draughts Game Phase 3 Epic" colour="danger" features={["Setting to decide who goes first", "Setting for if singles can take kings", "Update how to play", "Give up button", "Go back to player settings", "Display mode when against PC", "Error message for game settings"]} status="Not started"></ProjectCard>
                            <ProjectCard title="Automated 2nd Player Phase 3 Epic" colour="warning" features={["Refactor logic from V1 and V2", "Improve algorithm with alpha beta pruning", "Experiment with different depths", "Improve evaluation function"]} status="In progress"></ProjectCard>
                            <ProjectCard title="Tutorial Epic" colour="danger" features={[]} status="Not started"></ProjectCard>
                            <ProjectCard title="Support Epic" colour="danger" features={["Game tips results in no possible moves (26/01/21)", "Player tips not showing all possible moves for a king (31/01/21)", "Player tips infinite loop (1/2/21)", "Double jumps and undo (2/2/21)", "Undo is hiding player tips when no moves have been made (6/2/21)", "Change board layout, currently back to front (16/2/21)", "No more moves check is too late (18/2/21)"]} status="Paused due to no further work"></ProjectCard>
