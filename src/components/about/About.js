                ...
                <Col xl="10">
                    ...
                    <div>
                        ...
                        <div className="card-columns">
                            ...
                            <ProjectCard title="Technical Debt Epic Epic" colour="danger" features={["Refactor main use effect logic ✔ (28/01/21)", "Refactor player tips logic", "Replace JS alert with bootstrap modal for invalid more"]} status="Paused due to no further work"></ProjectCard>
                        </div>
                    </div>
                    <br></br>
                </Col>
