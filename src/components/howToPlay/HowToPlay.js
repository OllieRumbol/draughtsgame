    ...
    <Row>
      ...
      <Col xl="10">
        ...
        <p>
          ...
          move in a diagonal direction by one square therefore not white square
        ...
        <h2>How to play</h2>
        <p>
          A yellow ring will appear around the piece to identify whos turn it is
        ...
        <p>
          To move a piece click on the piece you want to move and the square you
          want to move it to. The game will do the rest and make you the move is
          valid.
        </p>
